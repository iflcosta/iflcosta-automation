    ...
    <section className="px-6 pt-10 pb-16 md:pt-20 md:pb-24">
      <div className="max-w-6xl mx-auto grid gap-12 md:grid-cols-2 md:items-center">
        <div className="text-center md:text-left">
          <div className="inline-flex items-center gap-2 rounded-full bg-ink/5 px-3 py-1 text-xs font-medium text-ink/70">
          ...
          <p className="mt-6 text-lg md:text-xl text-ink/80 max-w-xl mx-auto md:mx-0">
          ...
          <div className="mt-8 flex flex-col items-center md:items-start gap-3">
            <a
              href={WA_URL}
              className="inline-flex items-center justify-center rounded-full bg-wagreen px-7 py-4 text-base font-semibold text-ink shadow-sm transition hover:brightness-95 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-deep"
            >
